...
function start(){
	...
	document.getElementById("show-modal").addEventListener("click",calculateDueDate,false);
...
function calculateDueDate(){
	...
	if((!isNaN(selectedDay)) && (!isNaN(selectedMonth)) && (!isNaN(yearEntered)) && (!isNaN(cycle))){
		...
		document.getElementById("resultPara").innerHTML = "Invalid input! Please fill in the form to calculate your duedate."
	} //end if /else
...
function clearAll(){
	//location.reload();
	document.getElementById("yearTextBox").value = "Year";
	document.getElementById("cycleTextBox").value = "Cycle in Days";
